...
class RLSDataModule(pl.LightningDataModule):
    def __init__(
        self,
        data_dir,
        binarize=False,
        ...
        super(RLSDataModule, self).__init__()
...
class RLSDataset(Dataset):
    def __init__(
        ...
        super(RLSDataset, self).__init__()
